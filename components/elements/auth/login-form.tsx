...
export default function LoginForm() {
	...
	return (
		<div className='w-full max-w-md p-8 rounded-3xl bg-[#1C1C1C] text-white'>
			<h1 className='text-[31px] font-bold text-center mb-[18px]'>Вхід</h1>

			<button
				// onClick={handleTelegramLogin}
				className='relative flex items-center gap-[22px] w-full mb-[18px] px-[60px] rounded-[41px] py-[19.5px] bg-transparent border border-[#fff] hover:bg-gray-800 text-[18px] font-bold'
			>
