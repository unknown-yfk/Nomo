...
//           <div className="mb-12">
//             <div className="w-full h-[400px] overflow-hidden relative rounded-xl shadow-lg">
//               <CarouselSingle />
//             </div>
//           </div>
...
//                 </motion.div>
//               ))}
//               <Card className="min-h-[250px] flex justify-center items-center border-dashed border-2 border-gray-300 hover:border-accent transition-colors duration-300">
//                 <CardContent className="flex flex-col items-center justify-center p-4 space-y-4">
//                   <button
  ...
  >
    ...
    <span>Фільтри</span>
            ...
            >
              ...
              <Card className="min-h-[200px] sm:min-h-[250px] flex justify-center items-center border-dashed border-2 border-gray-300 hover:border-accent transition-colors duration-300">
                <CardContent className="flex flex-col items-center justify-center p-4 space-y-4">
                  <button
                    className="w-full h-full flex justify-center items-center text-5xl sm:text-7xl text-gray-400 hover:text-accent transition-colors duration-300"
                    onClick={handleAddDeal}
                  >
                    +
                  </button>
