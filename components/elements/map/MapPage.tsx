...
//       <section className="py-4 sm:py-4 md:py-8 lg:py-[60px] px-4 sm:px-10">
//         <div className="containers px-2 sm:px-6 lg:px-8">
//           {/* Partners Map Section */}
//           <div className="mb-16">
//             <div className="text-center mb-6 py-4">
//               <h2 className="text-white text-xl sm:text-2xl font-bold py-2">КАРТА ПАРТНЕРІВ</h2>
...
//           <div className="mb-16">
//             <h2 className="text-white text-xl sm:text-2xl font-bold mb-4 sm:mb-6">НАШІ ПАРТНЕРИ ПОБЛИЗУ</h2>
//             <div className="flex flex-col sm:flex-row gap-4 mb-8 w-full">
//               <div className="flex-grow relative max-w-[700px]">
//                 <Search className="absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-400 w-5 h-5" />
//                 <Input
//                   placeholder="Пошук (вкажіть назву або категорію)"
//                   className="w-full bg-white border-none text-gray-900 h-[52px] pl-12 pr-4 rounded-md placeholder:text-gray-500"
//                 />
//               </div>
//               <Button className="bg-[#FF8D2A] hover:bg-[#FF8D2A]/90 text-white h-[52px] px-8 text-base font-medium rounded-md whitespace-nowrap">
//                 ВИЗНАЧИТИ ЛОКАЦІЮ
//               </Button>
//             </div>
...
//                 <Card key={partner.id} className="bg-[#1a1a1a] border-none hover:bg-[#252525] transition-colors">
//                   <CardContent className="p-4 flex items-center space-x-3">
//                     <div className="w-10 h-10 bg-white rounded-full flex-shrink-0">
//                       <div className="w-[40px] h-[40px] bg-white rounded-full flex-shrink-0 overflow-hidden flex items-center justify-center">
//                         {partner.logoUrl ? (
//                           <Image
...
//                       <p className="text-gray-400 text-xs truncate">{partner.subtitle}</p>
//                     </div>
//                   </CardContent>
//                 </Card>
//               ))}
...
//                 </div>
//               </div>
//               <div className="relative h-[300px] sm:h-[400px] bg-[#0B1C3D] rounded-[100px] sm:rounded-[200px] overflow-hidden">
//                 <div className="absolute inset-0 flex items-center justify-center p-0">
//                   <img src="/globe.png" alt="Global presence map" className="w-full h-full object-cover" />
//                 </div>
//               </div>
//             </div>
//           </div>
...
//             <div>
//               <h3 className="text-[#FF8D2A] text-4xl sm:text-5xl font-bold mb-2 sm:mb-4">42</h3>
//               <p className="text-gray-400 text-sm">Міст у понал 12 Країнах</p>
//             </div>
//             <div>
//               <h3 className="text-[#FF8D2A] text-4xl sm:text-5xl font-bold mb-2 sm:mb-4">~1500</h3>
//               <p className="text-gray-400 text-sm">
//                 До нас постійно підключаються нові партнери. І їхня кількість зростає з кожним днем, оскільки вона
//                 інтегрується з нашою платформою.
//               </p>
//             </div>
//             <div>
//               <h3 className="text-[#FF8D2A] text-4xl sm:text-5xl font-bold mb-2 sm:mb-4">6</h3>
//               <p className="text-gray-400 text-sm">
//                 Ми активно розвиваємо мережу франшиз. І їхня кількість постійно зростає.
//               </p>
//             </div>
//             <div>
//               <h3 className="text-[#FF8D2A] text-4xl sm:text-5xl font-bold mb-2 sm:mb-4">~45000</h3>
//               <p className="text-gray-400 text-sm">
//                 Кількість наших користувачів постійно зростає, оскільки все більше людей приєднується до нашої
//                 платформи.
//               </p>
//             </div>
//           </div>
