...
// import { ArrowLeft, ArrowRight, ChevronLast, ChevronRight } from "lucide-react"

// // Sample data to match image exactly
// const products = [
...
//           <SelectTrigger className="w-[120px] bg-[#c65d2e] text-white hover:bg-[#b35429] border-none text-xs py-1 h-8">
...
//                       <span className="line-through border-b border-dotted border-gray-600 pb-0.5">
//                         {product.prices[0]}
//                       </span>
//                       <span className="text-[#c65d2e] pt-0.5">{product.prices[1]}</span>
//                     </div>
//                   ) : (
//                     product.price
//                   )}
...
//                     variant="ghost"
//                     // size="sm"
//                     className="bg-[#c65d2e]  bg-opacity-80 text-orange-400 hover:bg-[#b35429] hover:bg-opacity-90 rounded-sm h-6 px-3 text-xs font-normal"
//                     >
//                     Складники
//                     <ChevronRight />
//                   </Button>
...
//           <button className="px-2 py-1 bg-[#c65d2e] text-white">1</button>
